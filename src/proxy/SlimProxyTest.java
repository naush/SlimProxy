...
public class SlimProxyTest extends TestCase {
	...
	private final String sampleLaunchCommand = "C:\\Ruby19\\bin\\ruby.exe -Ku  -I  C:\\fixtures\\ C:\\RubySlim\\lib\\run_ruby_slim.rb 8085";

//	@Test
//	public void testGetInstructionsFromClient() throws NumberFormatException, Exception {
//		ByteArrayInputStream is = new ByteArrayInputStream(new String("000001:i").getBytes());
//		StreamReader reader = new StreamReader(is);
//		String instructions = SlimProxyServer.getInstructionsFromFitnesse(reader);
//		assertEquals("i", instructions);
//	}

	@Test
	public void testSendSampleInstructionRubySlim() throws Exception {
		Process p = Runtime.getRuntime().exec(sampleLaunchCommand);
		SlimProxyClient slimPClient= new SlimProxyClient("127.0.0.1", 8085);
		slimPClient.connect();
